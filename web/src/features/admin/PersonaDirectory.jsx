...
export function PersonaDirectory({ role }) {
  if (!['PLATFORM_ADMIN', 'DEMO_PRESENTER'].includes(role)) return <section className="feature-page"><WorkspaceHeader eyebrow="Authorization" title="Workspace not authorized" description="This directory is restricted to platform governance and the Development demo presenter." /></section>;
  ...
  return <section className="feature-page">
    ...
    {!canOpen && <div className="partial-state">A Development demo presenter account is required to open another persona. Platform administrators retain their own non-evidence role.</div>}
